...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/roam-ios/Roam/AWSAuthCore.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/roam-ios/Roam/AWSCognitoIdentityProvider.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/roam-ios/Roam/AWSCognitoIdentityProviderASF.framework"
